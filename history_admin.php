...
<body>
    ...
    <section id="promo">
        ...
        <table class="table table-bordered table-striped table-hover">
           ...
           $dataCart = $konek->query("SELECT * FROM `user` INNER JOIN `transaksi` WHERE `user`.`id` = `transaksi`.`id_user` AND `transaksi`.`id_status` = '2'");
            $i = 1;
            ...
            ?>
                    ...
                    <tr class="product-row">
                        ...
                        <td class="id_user"><?php echo $value['id_user'] ?></td>
                        <td class="nama"><?php echo $value['nama'] ?></td>
                        ...
                        <td><a href="detail_admin.php?waktu= <?= $value['waktu_order'] ?>" class="btn btn-primary" ;>Detail</a></td>
