	...
	<header>
		<nav class="navbar fixed-top" style="background-color: #0274BC; padding: 20px;">
			...
			<ul>
				...
				<li class="dropdown"><a href="kategori_admin.php" class=" dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Kategori</a>
	...
	<section id="promo">
		<div class="container">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<input type="number" id="harga" name="harga" placeholder="Masukkan harga Bahan Makanan.." required>
				...
				<label></label>
				<button type="submit" style=" background-color: #0274BC;">Tambah Data</button>
			</form>
			<label></label>
			<button style=" background-color: red;max-width: 600px;
      margin: 0 auto;"><a href="kategori_admin.php" style="color: whitesmoke;text-decoration: none;">Batal</a></button>
		</div>
	</section>
