...
<body>
    ...
    <section id="promo">
        ...
        <a href="history.php" class="btn btn-danger" ><img src="img/back.svg" alt="back"> Back</a>
            <br>
        <table class="table table-bordered table-striped table-hover">
            ...
            $dataCart = $konek->query("SELECT * FROM `cart` WHERE `cart`.`id_user` = '$idUser' AND `cart`.`id_status` = '2' AND `cart`.`tanggal_pembelian` = '$waktu'");
